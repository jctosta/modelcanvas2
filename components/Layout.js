    ...
    return (
        <>
            ...
            {/* <motion.div className={`flex-grow ${hiddenSidebar ? "hidden" : "fixed z-10 md:static block"} md:flex-none w-5/6 md:w-1/6 h-screen bg-gray-900 shadow-lg`} animate={hiddenSidebar ? "open" : "closed"} variants={variants}> */}
                <motion.div className={`flex-grow fixed z-20 md:static md:flex-none w-5/6 md:w-1/6 h-screen bg-gray-900 shadow-lg`} animate={hiddenSidebar ? "open" : "close"} variants={variants}>
                    <div className="flex flex-col">
                        <div className="flex-none bg-blue-500 shadow p-4">
                    ...
                    {/* <Image src="/LogoModelCanvasVertical.svg" alt="Logotipo do Aplicativo Model Canvas" width={439} height={287} /> */}                    
                </motion.div>
                <div className={`w-full h-screen bg-black bg-opacity-30 fixed z-10 ${hiddenSidebar ? "block md:hidden" : "hidden"}`} onClick={() => toggleSidebar()}></div>
                {/* Main Container */}
                <div className="flex-grow self-stretch md:flex-grow h-screen">
                    <div className="flex flex-col w-full flex-1">
                        <div className="flex-none fixed w-full z-0">
                            <div className="flex flex-row custom-bg w-full">
                                ...
                                <div className="flex-grow w-2/4 text-center">
                                    <h2 className="p-3 font-extrabold text-base uppercase text-gray-800 truncate overflow-ellipsis">Business Model Canvas</h2>
                                </div>
                                <div className="flex-none p-4 w-1/4">
